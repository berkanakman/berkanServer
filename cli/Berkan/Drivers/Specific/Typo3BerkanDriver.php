...
class Typo3BerkanDriver extends BerkanDriver
{
    /**
    ...
    {
        return is_dir($sitePath . '/typo3')
            && (is_dir($sitePath . '/typo3conf') || file_exists($sitePath . '/config/system/settings.php'));
    }
    ...
    /**
     * Determine the public directory for the TYPO3 installation.
     */
